...
- Move `respect-ignore-files` under `src` section ([#18322](https://github.com/astral-sh/ruff/pull/18322))
...
- Add warning that docs are autogenerated ([#18270](https://github.com/astral-sh/ruff/pull/18270))
...
- Fix anchor tag in `README` ToC ([#486](https://github.com/astral-sh/ty/pull/486))
