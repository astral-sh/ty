...
- Fix incorrect lsp inlay hint type ([#20044](https://github.com/astral-sh/ruff/pull/20044))
...
- Re-arrange "list modules" implementation for Salsa caching ([#19987](https://github.com/astral-sh/ruff/pull/19987))
- Use Salsa to cache workspace symbols ([#20030](https://github.com/astral-sh/ruff/pull/20030))
...
- Add support for PEP 800 ([#20084](https://github.com/astral-sh/ruff/pull/20084))
...
- Evaluate reachability of non-definitely-bound to Ambiguous ([#19579](https://github.com/astral-sh/ruff/pull/19579))
...
- No boundness analysis for implicit instance attributes ([#20128](https://github.com/astral-sh/ruff/pull/20128))
- Add Top[] and Bottom[] special forms, replacing top_materialization_of() function ([#20054](https://github.com/astral-sh/ruff/pull/20054))
- Add constraint set implementation ([#19997](https://github.com/astral-sh/ruff/pull/19997))
- Introduce a representation for the top/bottom materialization of an invariant generic ([#20076](https://github.com/astral-sh/ruff/pull/20076))
- Optimize TDD atom ordering ([#20098](https://github.com/astral-sh/ruff/pull/20098))
- Perform assignability etc checks using new `Constraints` trait ([#19838](https://github.com/astral-sh/ruff/pull/19838))
- Preserve qualifiers when accessing attributes on unions/intersections ([#20114](https://github.com/astral-sh/ruff/pull/20114))
- Simplify materialization of specialized generics ([#20121](https://github.com/astral-sh/ruff/pull/20121))
...
- Don't assume that deferred type inference means deferred name resolution ([#20160](https://github.com/astral-sh/ruff/pull/20160))
