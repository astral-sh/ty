...
- Add support for Debian/Ubuntu `dist-packages` directories ([#22466](https://github.com/astral-sh/ruff/pull/22466))
...
- Fix `__contains__` to respect descriptors ([#23056](https://github.com/astral-sh/ruff/pull/23056))
...
- Fix nested `NewType`s with add `Type::as_union_like` ([#22997](https://github.com/astral-sh/ruff/pull/22997))
- Fix query cycles in decorated function with parameter defaults ([#23014](https://github.com/astral-sh/ruff/pull/23014))
- Fix unary and comparison operators for TypeVars with union bounds ([#22925](https://github.com/astral-sh/ruff/pull/22925))
- Fix visibility of field specifiers when models are nested inside methods ([#23069](https://github.com/astral-sh/ruff/pull/23069))
...
- Add a diagnostic for `Final` without assignment ([#23001](https://github.com/astral-sh/ruff/pull/23001))
...
- Allow self-referential imports outside global scope ([#22963](https://github.com/astral-sh/ruff/pull/22963))
...
- Detect generic `Callable`s in function signatures ([#22954](https://github.com/astral-sh/ruff/pull/22954))
...
- Diagnostic on overridden comparison dunder methods on `order=True` dataclasses ([#22689](https://github.com/astral-sh/ruff/pull/22689))
...
- Remove `static_expression_truthiness` and improve reachability analysis ([#22971](https://github.com/astral-sh/ruff/pull/22971))
- Remove special handling for `Any()` in match class patterns ([#23011](https://github.com/astral-sh/ruff/pull/23011))
- Resolve type aliases in `filter_union` method ([#22989](https://github.com/astral-sh/ruff/pull/22989))
- Support `pkg_resources.declare_namespace` for legacy namespace packages ([#22987](https://github.com/astral-sh/ruff/pull/22987))
