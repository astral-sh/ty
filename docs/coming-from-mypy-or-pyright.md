...
| [`invalid-assignment`][ty-invalid-assignment]                                                                                | [`assignment`][mypy-assignment]<br>[`list-item`][mypy-list-item]<br>[`dict-item`][mypy-dict-item]<br>[`typeddict-readonly-mutated`][mypy-typeddict-readonly-mutated] | [`reportAssignmentType`][reportassignmenttype]<br>[`reportTypedDictNotRequiredAccess`][reporttypeddictnotrequiredaccess]                                                               |
