...
| [Ruff `PYI010`][ruff-pyi010]                                                   |                                                         | `reportInvalidStubStatement`                                 |
...
| [Ruff `F822`][ruff-f822]<br>[Ruff `PLE0605`][ruff-ple0605]                     |                                                         | `reportUnsupportedDunderAll`                                 |
...
[ruff-ann]: reference/typing-faq.md#why-doesnt-ty-warn-about-missing-type-annotations
