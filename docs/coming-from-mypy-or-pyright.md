...
| [`possibly-missing-attribute`][ty-possibly-missing-attribute]                                                                | [`union-attr`][mypy-union-attr]                                                                                                | [`reportOptionalMemberAccess`][reportoptionalmemberaccess]<br>[`reportAttributeAccessIssue`][reportattributeaccessissue] |
...
| [`unresolved-attribute`][ty-unresolved-attribute]                                                                            | [`attr-defined`][mypy-attr-defined]                                                                                            | [`reportAttributeAccessIssue`][reportattributeaccessissue]                                                               |
